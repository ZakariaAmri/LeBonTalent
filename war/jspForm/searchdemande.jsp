...
<section class="menu-section">
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Recherche</h4>
                </div>
			</div>
			<div class="row">
                    <div class="col-md-6">
...
<form method="post" action="searchd">
  ...
  <div class="form-group">
    ...
    <input name="titre" type="text" class="form-control" placeholder="Entrer un titre" id="titre" />
  </div>
  <div class="form-group">
    <label for="localisation">Localisation</label>
<input name="localisation" type="text" class="form-control" placeholder="Votre localisation" id="localisation" />
  </div>
   <div class="form-group">
    <label for="prix">Prix</label>
    <input name="prix" type="text" class="form-control" id="prix" placeholder="votre prix" />
  </div>
  <button type="submit" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-search"></span>   Lancer la recherchre</button> 
  </form>
                        </div>
              	 </div>
