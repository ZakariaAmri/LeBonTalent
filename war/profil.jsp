                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel-heading">
                           Information profil
                        	...
                        	<% 
           					 model.Utilisateur attribut2 = (model.Utilisateur) request.getAttribute("Utilisateur");
                        	 out.println( " <label for=\"login\">Email :</label>");
           					 out.println( attribut2.getEmail() +"<br>");
           					out.println( " <label for=\"login\">Login :</label>");
           					 out.println( attribut2.getLogin()+"<br>" );
           					out.println( " <label for=\"login\">Adresse :</label>");
          					 out.println( attribut2.getAdresse()+"<br>");
           					%>
                        ...
                        <div class="panel-heading">
                           Mes Demandes
							...
							<div class="panel-body">
								<div class=\"row\">
                        	<% 
                        	List<model.Demande> demandes = (List<model.Demande>) request.getAttribute("UtilisateurDemande");
                        ...
                        <div class="panel-heading">
                           Mes Annonces
							...
							<div class="panel-body">
								<div class=\"row\">
                        	<% 
                        	List<model.Demande> demandes2 = (List<model.Demande>) request.getAttribute("UtilisateurAnnonce");
                        	if(demandes2.isEmpty()||demandes2.size()==0){
                        		out.print("<h5>Vous avez poster aucune annonce\"</h5> ");
                        	}else{
                            for(int i = 0; i< demandes2.size();i++ ) {          	
                            	request.setAttribute("DemandeDetail", demandes2.get(i));
                				//request.getParameter("refDemande");
                				String design="<div class=\"col-md-3 col-sm-3 col-xs-6\"><div class=\"dashboard-div-wrapper bk-clr-two\"><i  class=\"fa fa-edit dashboard-div-icon\" ></i><div class=\"progress progress-striped active\"><div class=\"progress-bar progress-bar-warning\" role=\"progressbar\" aria-valuenow=\"80\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: 100%\"></div></div>";
                				out.print(design+"<a href ="+request.getContextPath()+"/demandedetails?refDemande="+demandes2.get(i).id+"><h5>"+demandes2.get(i).getTitre()+"</h5></a></div></div>");
                				}
                        	}
           					%>
           					</div>
